...
import {ArrowRight, Building2, DatabaseZap, Factory, ListChecks, MessageSquareQuote} from 'lucide-react';
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <MetricCard title={t('metrics.review.title')} value={String(counts.review_queue ?? 0)} detail={t('metrics.review.detail')} tone="accent" />
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {surfaceKeys.map((key) => {
              ...
              return (
                <Link
                  key={key}
                  href={getOperatorUrl(t(`surfaces.${key}.href`))}
